...
class Examination
{
	...
	function __construct()
	{
		...
		$this->password = '';
		$this->database = 'exam';
		$this->home_page = 'http://localhost/exam/';
	...
	function send_email($receiver_email, $subject, $body)
	{
		...
		$mail->Username = 'bangalibhaiofficial@gmail.com';

		$mail->Password = 'mug131198';

		$mail->SMTPSecure = '';

		$mail->From = 'bangalibhaiofficial@gmail.com';

		$mail->FromName = 'bangalibhaiofficial@gmail.com';
